...
void Example::keyboard(unsigned char key, int x, int y) {
...
void Example::DrawTriangle(void) {
    glLoadIdentity();                  // Reset the model-view matrix
...
void Example::reshape(int width, int height) {
...
int Example::main_gl(int argc, char** argv) {
    glutInit(&argc, argv);            // Initialize GLUT
    glutInitDisplayMode(GLUT_DOUBLE); // Enable double buffered mode
    glutInitWindowSize(640, 480);   // Set the window's initial width & height
    glutInitWindowPosition(50, 50); // Position the window's initial top-left corner
    glutCreateWindow("Example");    // Create window with the given title
