...
//AppSDL* AppSDL::GetInstance() { return &AppSDL::_instance; }

//SDL_Renderer* AppSDL::GetRenderer() { return Renderer; }

//int AppSDL::GetWindowWidth() { return WindowWidth; }
//int AppSDL::GetWindowHeight() { return WindowHeight; }
